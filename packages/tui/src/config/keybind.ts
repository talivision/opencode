...
export const Definitions = {
  ...
  session_search: keybind("<leader>f", "Find in transcript"),
  session_refresh: keybind("ctrl+shift+r", "Refresh session display"),
  ...
  session_parent: keybind("<leader>up", "Go to parent session"),
